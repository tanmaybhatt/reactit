...
var repos = {
    ...
    express_iso : {
         repo : "https://nodeload.github.com/tanmaybhatt/react-express-boilerplate/zip/iso",
        folder : "react-express-boilerplate-iso/"
    }
}
...
args.forEach(function(item,index){
    ...
    else if(item.indexOf('-')==0 && item!='new' && index>newIndex)
    {
        ...
        else if(item == "--express-iso")
        {
            repo = repos.express_iso.repo;
            folder = repos.express_iso.folder;
            type = "Isomorphic";
        }
        else if(item == "--simple")
        {
